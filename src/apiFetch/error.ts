...
interface ErrorProps {
    success: boolean,
    erro: "Erro de validação dos dados" | "Erro desconhecido" | "Erro de conexão com o banco de dados" | "Já existe um registro com este valor único" | "O registro solicitado não foi encontrado",
